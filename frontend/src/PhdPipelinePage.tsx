...
const PhdPipelinePage: React.FC<PhdPipelinePageProps> = ({
  ...
  const [assembleStats, setAssembleStats] = useState<{
    cited: number;
    sections: number;
  } | null>(null);
    ...
    <div className="phd-pipeline-page">
      ...
      <div className="pipeline-steps-container">
        ...
        <div className="pipeline-step">
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              cursor:
                frameworkLoading || !topic.trim() || frameworkConfirmed
                  ? "not-allowed"
                  : "pointer",
              opacity:
                frameworkLoading || !topic.trim() || frameworkConfirmed
        ...
        <div className="pipeline-step">
          ...
          <button
            onClick={handleStep1_GenerateClaims}
        ...
        <div className="pipeline-step">
          ...
          <button
            onClick={handleStep2_AttachEvidence}
            disabled={
        ...
        <div className="pipeline-step">
          <h3>步骤 3: 渲染最终综述</h3>
          <button
            onClick={handleStep3_RenderSection}
            disabled={
